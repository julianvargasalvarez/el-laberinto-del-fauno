...
class TestCell < Test::Unit::TestCase
  def test_shows_cell_details_by_cell_name
    ...
    assert_equal(traiga(mundo, 'nabuconudosor', 'af1'), { nombre: 'af1', arriba: 'ach', abajo: 'rti', derecha: 'zlm', izquierda: 'nac', tesoro: 'linterna', fauno: true, pista: 'a' })
  end
  ...
  def test_pickup_treasure_from_cell_by_name_when_there_is_treasure_and_the_treasures_are_equal
    ...
    assert_equal(traiga(mundo, 'nabuconudosor', 'af1'), { nombre: 'af1', arriba: 'ach', derecha: 'zlm', fauno: true, pista: 'a' })
  end
